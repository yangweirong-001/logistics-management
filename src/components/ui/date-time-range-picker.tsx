...
interface DateTimeRangePickerProps {
  ...
  width?: string; // 自定义宽度
  onOpenChange?: (isOpen: boolean) => void; // 打开/关闭状态回调
}

export default function DateTimeRangePicker({ value, onChange, placeholder = '选择日期时间范围', showTime = true, width = '280px', onOpenChange }: DateTimeRangePickerProps) {
